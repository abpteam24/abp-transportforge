	...
	if (!class_exists('ABPTF_Dependencies')) {
		class ABPTF_Dependencies {
			...
			public function admin_enqueue($hook): void {
				...
				wp_localize_script('abptf_sp', 'abptf_sp_config', [
					'seat_type' => wp_json_encode(ABPTF_Seat_Plan::get_ticket_type_js()),
					'ajax_url' => admin_url('admin-ajax.php'),
					'nonce' => wp_create_nonce('abptf_admin_ajax_nonce'),
					'decor_item' => wp_json_encode(ABPTF_Seat_Plan::get_decor_js()),
					'msg' => [
						'sp_delete_confirm' => __('Are you sure you want to delete this Seat Plan?', 'abp-transportforge'),
						'sp_clear_confirm' => __('Are you absolutely sure you want to clear the full layout?', 'abp-transportforge'),
						'sp_clear' => __('Layout clear successfully.............!', 'abp-transportforge'),
						'sp_deleting' => __('Seat Plan Deleting.............!', 'abp-transportforge'),
						'sp_saving' => __('Seat Plan Saving.............!', 'abp-transportforge'),
						'sp_loading' => __('Seat Plan Loading.............!', 'abp-transportforge'),
					],
				]);
				//=============================//
