		...
		class ABPTF_Status {
			...
			public static function add_data( $_category ): void {
				...
				if ( isset( $dummy_infos['options'] ) ) {
					...
					ABPTF_Feature::update_feature_js();
				}
			...
			public static function dummy_data(): array {
				return [
					...
					'options'     => [
						'abptf_feature'    => ABPTF_Layout::static_feature(),
						'abptf_additional' => ABPTF_Layout::static_additional(),
						'abptf_forms'      => ABPTF_Layout::static_form(),
					],
					'custom_post' => [
						'abptf_post' => [
							'transport' => [
