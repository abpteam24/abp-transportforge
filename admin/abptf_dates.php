	...
	if ( ! class_exists( 'ABPTF_Dates' ) ) {
		class ABPTF_Dates {
			public function __construct() {
				...
				add_action( 'wp_ajax_abptf_save_global_date', array( $this, 'save_global_date' ) );
			...
			public function global_dates(): void {
                ...
                <form class="save_dates" method="post" action="">
                    ...
                    <div class="_divider_xs"></div>
                    <button type="submit" class="_btn_theme"><span class="_mar_r_xxs">💾</span><?php esc_html_e( 'Save Date Configuration', 'abp-transportforge' ); ?></button>
                </form>
				<?php
			}
			...
			public function save_global_date(): void {
				...
				wp_send_json_success( [ 'msg' => __( 'Global Date Configuration Saved Successfully ..... !! ', 'abp-transportforge' ), 'type' => 'success' ], 200 );
			}
			...
			public function date_wise_time( $date_times = [] ): void {
                ...
                <div class="setting_item full_width _mar_t_xs configuration_content   <?php echo esc_attr( ! empty( $day_times ) ? 'abp_active' : '' ); ?>" data-collapse="#date_wise_time">
                    ...
                    <div class="abptf_d_none" data-hidden_id>
                        <div class="hidden_content">
