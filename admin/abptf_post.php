		...
		class ABPTF_Post {
			...
			public function settings(): void {
				...
				if ( ! empty( $copy_post_id ) && isset( $_GET['_abptf_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_abptf_nonce'] ) ), 'abptf_copy_post_action' ) && current_user_can( 'edit_post', $copy_post_id ) ) {
					...
					<?php
					$abptf_infos['copy_post_id'] = $copy_post_id;
					$new_post_id                 = $copy_post_id;
				} else {
					$new_post_id = $post_id;
				}
				$abptf_infos = ABPTF_Function::get_all_meta( $new_post_id );
                        ...
                        <div class="abptf_tabs tab_top">
                            <div class="_panel_head">
                                <ul class="_abp tab_lists">
									...
									<?php } ?>
									<?php do_action( 'abptf_post_tab_menu', $abptf_infos ); ?>
                            ...
                            <div class="tab_content _panel_body">
								<?php
									$this->general_configuration( $abptf_infos );
									do_action( 'abptf_post_content', $abptf_infos );
								?>
                            </div>
                        </div>
                    </div>
			...
			public function general_configuration( $abptf_infos ): void {
				$abptf_template = $abptf_infos['abptf_template'] ?? 'default';
				?>
                    ...
                    <div class="group_setting">
                        <div class="setting_item">
                            <div class="_fa_center">
								<?php ABPTF_Layout::switch_checkbox( 'sale_continue', ( $abptf_infos['sale_continue'] ?? 'on' ) ); ?>
						...
						<?php if ( ABPTF_Function::on_off( 'sku' ) ) { ?>
                            <div class="setting_item">
                                <div class="_fj_between">
                                    <div class="_fa_center">
										<?php ABPTF_Layout::switch_checkbox( 'display_sku', ( $abptf_infos['display_sku'] ?? 'off' ) ); ?>
                                        <span class="_abp_label"><?php esc_html_e( 'ID/SKU', 'abp-transportforge' ); ?></span>
                                    </div>
                                    <label>
                                        <input class="_form_control" name="post_sku" value="<?php echo esc_attr( $abptf_infos['post_sku'] ?? '' ); ?>" placeholder="<?php esc_attr_e( 'Transport ID', 'abp-transportforge' ); ?>"/>
                                    </label>
                                </div>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'post_icon' ) ) { ?>
                            <div class="setting_item">
                                <divl class="_fj_between">
									...
									<?php do_action( 'abptf_add_icon', 'post_icon', ( $abptf_infos['post_icon'] ?? '' ) ); ?>
                                </divl>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'sub_title' ) ) { ?>
                            <div class="setting_item">
                                <div class="_f_equal_f_wrap">
                                    ...
                                    <label>
                                        <textarea class="_form_control" name="sub_title" placeholder="<?php esc_attr_e( 'Transport Sub Title', 'abp-transportforge' ); ?>"><?php echo esc_html( $abptf_infos['sub_title'] ?? '' ); ?></textarea>
                                    </label>
                                </div>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'post_des' ) ) { ?>
                            <div class="setting_item">
                                <label class="_f_equal_f_wrap">
                                    ...
                                    <textarea class="_form_control" name="post_description" placeholder="<?php esc_attr_e( 'EX: Description', 'abp-transportforge' ); ?>"><?php echo esc_html( $abptf_infos['post_description'] ?? '' ); ?></textarea>
                                </label>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'organizer' ) ) { ?>
                            <div class="setting_item">
                                <div class="_fj_between_fa_center">
                                    <div class="_fa_center">
										<?php ABPTF_Layout::switch_checkbox( 'display_organizer', ( $abptf_infos['display_organizer'] ?? 'off' ) ); ?>
                                        <span class="_abp_label"><?php echo esc_html( ABPTF_Function::organizer_label() ); ?></span>
                                    </div>
									<?php ABPTF_Layout::button_popup_global( 'organizer', __( 'Add New', 'abp-transportforge' ) . ' ' . ABPTF_Function::organizer_label() ); ?>
                                    <div class="organizer_selection"><?php ABPTF_Organizer::organizer_selection( $abptf_infos['abptf_organizer'] ?? '' ); ?></div>
                                </div>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'brand' ) ) { ?>
                            <div class="setting_item">
                                <div class="_fj_between_fa_center">
                                    <div class="_fa_center">
										<?php ABPTF_Layout::switch_checkbox( 'display_brand', ( $abptf_infos['display_brand'] ?? 'off' ) ); ?>
                                        <span class="_abp_label"><?php echo esc_html( ABPTF_Function::brand_label() ); ?></span>
                                    </div>
									<?php ABPTF_Layout::button_popup_global( 'brand', __( 'Add New', 'abp-transportforge' ) . ' ' . ABPTF_Function::brand_label() ); ?>
                                    <div class="brand_selection"><?php ABPTF_Brand::brand_selection( $abptf_infos['abptf_brand'] ?? '' ); ?></div>
                                </div>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'category' ) ) { ?>
                            <div class="setting_item">
                                <div class="_fj_between_fa_center">
                                    <div class="_fa_center">
										<?php ABPTF_Layout::switch_checkbox( 'display_category', ( $abptf_infos['display_category'] ?? 'on' ) ); ?>
                                        <span class="_abp_label"><?php echo esc_html( ABPTF_Function::category_label() ); ?></span>
                                    </div>
									<?php ABPTF_Layout::button_popup_global( 'category', __( 'Add New', 'abp-transportforge' ) . ' ' . ABPTF_Function::category_label() ); ?>
                                </div>
                                <div class="_divider_xs"></div>
                                <div class="category_selection">
									<?php ABPTF_Category::category_selection( $abptf_infos['abptf_category'] ?? '' ); ?>
                                </div>
                                <div class="_divider_xs"></div>
						...
						<?php if ( ABPTF_Function::on_off( 'related' ) ) { ?>
                            <div class="setting_item related_item">
                                ...
                                <div class="selected_area">
                                    <input type="hidden" name="related_item" value="<?php echo esc_attr( $abptf_infos['related_item'] ?? '' ); ?>"/>
						...
						<?php if ( ABPTF_Function::on_off( 'feature' ) ) { ?>
                            <div class="setting_item full_width post_feature">
                                ...
                                <div class="_divider_xs"></div>
                                <div class="selected_area">
                                    <input type="hidden" name="post_feature" value="<?php echo esc_attr( $abptf_infos['post_feature'] ?? '' ); ?>"/>
                                    <div class="selected_list"></div>
                                </div>
                                <div class="_divider_xs"></div>
                        ...
                        <div class="setting_item full_width">
                            ...
                            <div class="_divider_xs"></div>
							<?php do_action( 'abptf_add_image_multiple', 'abptf_sliders', ( $abptf_infos['abptf_sliders'] ?? '' ) ); ?>
                        </div>
                    </div>
                </div>
				<?php
			...
			public function save_settings( $post_id ): void {
				...
				if ( get_post_type( $post_id ) == ABPTF_Function::get_cpt() ) {
					...
					if ( ! empty( $date_time_ids ) ) {
						foreach ( $date_time_ids as $key => $time_id ) {
