                    ...
                    <div class="_panel_head">
                        <div class="_group_content_w_full">
                            ...
                            <?php if (ABPTF_Function::on_off('feature')) { ?>
                                <a href="<?php echo esc_url(ABPTF_Function::build_url('global', ['global' => 'feature'])); ?>" class="_btn_light_green_pale_xs  <?php echo esc_attr($active_tab == 'feature' ? 'abp_active' : ''); ?>"><span class="_mar_r_xxs">🔗</span><?php echo esc_html(ABPTF_Function::feature_label()); ?></a>
                            <?php } ?>
                        </div>
                    </div>
